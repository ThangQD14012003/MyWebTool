    ...
    <div class="container">
      ...
      <div class="my-3" v-if="table.length">
        <select class="form-control" v-model="tableName">
          <option disabled value="">Select the table to import data</option>
      ...
      <form-message
        v-if="errorTa == 1"
        @cancel="close"
        content="Select the table name to continue..."
      />
        ...
        <div v-if="dbColumns.length">
          <form @submit.prevent="submitMapping">
            <h3 class="text-center">
              Fill in the columns in the excel file corresponding to the fields in the
              database
            </h3>
            <div v-for="(column, index) in dbColumns" :key="index">
              <div>
                <div v-if="column.isIdentity" class="form-group">
                  ...
                  <input
                    disabled
                    placeholder="Auto-incrementing primary key"
                    class="form-control"
